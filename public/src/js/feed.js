...
locationBtn.addEventListener('click', function (event) {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        locationInput.value = 'In indonesia ' + fetchedLocation.lat;
...
function openCreatePostModal() {
    ...
    // remove service worker from the app
    /*
...
function createCard(data) {
    ...
    cardTitle.style.backgroundPosition = 'center center';
    ...
    cardSaveButton.addEventListener('click', function(){
        console.log('click');
        if('caches' in window) {
            caches.open('app-user-requested')
                .then(function (cache) {
